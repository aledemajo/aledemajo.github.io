...
class IframeView {
  ...
  render(request, show) {
    ...
    return this.sectionRender.then(function (contents) {
      ...
      this.layout.format(this.contents, this.section); // find and report the writingMode axis

      let writingMode = this.contents.writingMode();
      let axis = writingMode.indexOf("vertical") === 0 ? "vertical" : "horizontal";
      this.setAxis(axis);
      this.emit(_utils_constants__WEBPACK_IMPORTED_MODULE_4__[/* EVENTS */ "c"].VIEWS.AXIS, axis); // Listen for events that require an expansion of the iframe
